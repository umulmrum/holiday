...
class Grisons extends Switzerland
{
    ...
    public function calculateHolidaysForYear(int $year): HolidayList
    {
        ...
        $holidays->add($this->getBerchtoldstag($year, HolidayType::DAY_OFF | HolidayType::PARTIAL_ONLY));
        $holidays->add($this->getEpiphany($year, HolidayType::OFFICIAL | HolidayType::DAY_OFF | HolidayType::PARTIAL_ONLY));
        $holidays->add($this->getSaintJosephsDay($year, HolidayType::OFFICIAL | HolidayType::DAY_OFF | HolidayType::PARTIAL_ONLY));
